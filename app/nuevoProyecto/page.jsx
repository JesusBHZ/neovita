...
<div style={styles.container}>
      ...
      <div style={styles.formContainer}>
        ...
        <div style={styles.inputGroup}>
          ...
          <div style={styles.mapPlaceholder}><div style={{ height: "400px", width: "100%" }}>
        ...
        <div style={styles.inputGroup }>
          <label style={style.label}>Consumo Energético del Proyecto:</label>
          <input
            type="number"
    ...
    </form>  {/* This closes the form element correctly */}
</div> 
  );
};
