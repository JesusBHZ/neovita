  ...
  return (
    <div style={{ width: "90%", margin: "0 auto", padding: "20px" }}>
      ...
      <div style={{ marginTop: "20px", padding: "15px", backgroundColor: "#f4f4f4", borderRadius: "8px" }}>
        ...
        <p><strong>Ubicación:</strong> {projectData.proyecto?.ubicacion || 'No disponible'}</p>
        <p><strong>Tipo de Terreno:</strong> {projectData.proyecto?.tipo_terreno || 'No disponible'}</p>
        <p><strong>Ecosistema Local:</strong> {projectData.proyecto?.ecosistema_local || 'No disponible'}</p>
        <p><strong>Uso Actual del Suelo:</strong> {projectData.proyecto?.uso_actual_suelo || 'No disponible'}</p>
      </div>
    </div>
  );
};
